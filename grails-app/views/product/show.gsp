	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.stockKeepingUnitNumber}">
				<li class="fieldcontain">
					<span id="stockKeepingUnitNumber-label" class="property-label"><g:message code="product.stockKeepingUnitNumber.label" default="Stock Keeping Unit Number" /></span>
					
						<span class="property-value" aria-labelledby="stockKeepingUnitNumber-label"><g:fieldValue bean="${productInstance}" field="stockKeepingUnitNumber"/></span>
				...
				<g:if test="${productInstance?.priceHistory}">
				<li class="fieldcontain">
					<span id="priceHistory-label" class="property-label"><g:message code="product.priceHistory.label" default="Price History" /></span>
					
						<span class="property-value" aria-labelledby="priceHistory-label"><g:fieldValue bean="${productInstance}" field="priceHistory"/></span>
